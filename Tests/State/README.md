...
The 11 groups cover player lifecycle and drive-reset notifications, simulation-owned death effects, camera/player isolation, speed feedback in every camera mode, persistent manual lens and orbit settings, free movement and zero-time updates, cinematic priority and recovery, portal cancellation/preemption, natural portal handoff and immediate teleport, session-reset/readonly-view boundaries, and fixed frame execution gates.
