workspace "EngineWorkspace"
  ...
  -- ==========================================
    ...
    project "Shaders"
        ...
        local shader_filter = "files:Assets/Shaders/*.vert or files:Assets/Shaders/*.frag or files:Assets/Shaders/*.comp or files:Assets/Shaders/*.geom"
        ...
        -- Filters select Premake settings; they do not condition Lua assignments.
        filter { "system:windows", shader_filter }
            buildcommands {
                "{MKDIR} \"%{wks.location}/Assets/Shaders/spirv\"",
                "\"%{wks.location}/glslc.exe\" \"%{file.abspath}\" -o \"%{wks.location}/Assets/Shaders/spirv/%{file.name}.spv\""
            }

        filter { "system:linux", shader_filter }
            buildcommands {
                "{MKDIR} \"%{wks.location}/Assets/Shaders/spirv\"",
