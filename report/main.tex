...
\author{Qidan Guo}
\authornotemark[1]
\email{dhfc0067@leeds.ac.uk}

\author{Junxian Li}
\authornotemark[1]
\email{jmhz0887@leeds.ac.uk}

\author{Chenghao Zhu}
\authornotemark[1]
\email{wqgc0081@leeds.ac.uk}
...
\begin{teaserfigure}
  \includegraphics[width=\textwidth]{figures/engine_image.png}
  \caption{Steer Engine: A performance-focused ECS engine showcasing Physically Based Rendering and Jolt Physics integration in a vehicular action game.}
  \label{fig:teaser}
\end{teaserfigure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{figures/simplified_architecture.png}
...
\begin{acks}
We thank our supervisor Rafael Kuffner dos Anjos, the teaching staff, our classmates, and our families for their invaluable support and guidance.
\end{acks}

\begin{thebibliography}{99}

\bibitem[Akenine-Möller (2018)]{RealTimeRendering} Tomas Akenine-Möller. 2018. Real-Time Rendering. A K Peters.
\bibitem[Beckmann and Spizzichino (1963)]{Beckmann} P. Beckmann and A. Spizzichino. 1963. The Scattering of Electromagnetic Waves from Rough Surfaces. Macmillan.
\bibitem[CD Projekt Red (2020)]{CyberpunkVulkan} CD Projekt Red. 2020. Cyberpunk 2077. CD Projekt.
\bibitem[Codemasters (2015)]{DirtRally} Codemasters. 2015. DiRT Rally. Codemasters.
\bibitem[Cook and Torrance (1982)]{CookTorrance} R. L. Cook and K. E. Torrance. 1982. A Reflectance Model for Computer Graphics. ACM Transactions on Graphics.
\bibitem[Cornut (2025)]{ImGui} Omar Cornut. 2025. Dear Imgui.
\bibitem[Coumans (2025)]{BulletPhysics} Erwin Coumans. 2025. Bullet Real-Time Physics Simulation.
\bibitem[Criterion Games (2022)]{NFSUnbound} Criterion Games. 2022. Need for Speed Unbound. Electronic Arts.
\bibitem[Electronic Arts (2025)]{Frostbite} Electronic Arts. 2025. Frostbite Engine Documentation.
\bibitem[Fabian (2018)]{DataOrientedDesign} Richard Fabian. 2018. Data-Oriented Design.
\bibitem[Ford (2017)]{OverwatchECS} Timothy Ford. 2017. Overwatch Gameplay Architecture and Netcode. GDC 2017.
\bibitem[Geelnard (2025)]{GLFW} Marcus Geelnard. 2025. GLFW.
\bibitem[Gneiting (2016)]{DoomVulkan} Axel Gneiting. 2016. The devil is in the details: idTech 6. SIGGRAPH 2016.
\bibitem[Gregory (2018)]{GameEngineArch} Jason Gregory. 2018. Game Engine Architecture, Third Edition. CRC Press.
\bibitem[Guerrilla Games (2022)]{HorizonFW} Guerrilla Games. 2022. Horizon Forbidden West. Sony Interactive Entertainment.
\bibitem[id Software (2020)]{DoomEternal} id Software. 2020. DOOM Eternal. Bethesda Softworks.
\bibitem[Khronos (2025)]{VulkanSpec} Khronos. 2025. Vulkan Documentation.
\bibitem[Mackenzie (2022)]{NFSUnboundTech} Oliver Mackenzie. 2022. Need for Speed Unbound tech review. EuroGamer.
\bibitem[Mertens (2025)]{Flecs} Sander Mertens. 2025. Flecs: A fast and lightweight C/C++ ECS. https://github.com/SanderMertens/flecs
\bibitem[Nintendo EAD (2014)]{MarioKart8} Nintendo EAD. 2014. Mario Kart 8. Nintendo.
\bibitem[NVIDIA (2025)]{PhysX} NVIDIA. 2025. NVIDIA PhysX SDK 4.0.
\bibitem[Overvoorde (2025)]{LearnVulkan} Alexander Overvoorde. 2025. Vulkan Tutorial.
\bibitem[Playground Games (2021)]{ForzaHorizon5} Playground Games. 2021. Forza Horizon 5. Xbox Game Studios.
\bibitem[Psyonix (2015)]{RocketLeague} Psyonix. 2015. Rocket League. Psyonix.
\bibitem[Rockstar North (2013)]{GTA5} Rockstar North. 2013. Grand Theft Auto V. Rockstar Games.
\bibitem[Rouwe (2021)]{JoltHorizon} Jorrit Rouwe. 2021. Physics Animation in Horizon Forbidden West. GDC 2021.
\bibitem[Rouwe (2025)]{JoltPhysics} Jorrit Rouwe. 2025. Jolt Physics. https://github.com/jrouwe/JoltPhysics
\bibitem[Sawicki (2025)]{VMA} Adam Sawicki. 2025. Vulkan Memory Allocator. AMD GPUOpen.
\bibitem[Schlick (1994)]{Schlick} Christophe Schlick. 1994. An Inexpensive BRDF Model for Physically-Based Rendering. Computer Graphics Forum.
\bibitem[Sellers (2015)]{OpenGLSuperBible} Graham Sellers. 2015. OpenGL SuperBible. Addison-Wesley.
\bibitem[Studio Liverpool (2008)]{Wipeout} Studio Liverpool. 2008. Wipeout HD. Sony Computer Entertainment.
\bibitem[Tchou (2017)]{DestinyECS} Chris Tchou. 2017. Destiny's Multithreaded Rendering Architecture. GDC 2017.
\bibitem[Tector (2014)]{ForzaPhysics} Chris Tector. 2014. Forza Motorsport 5: Next-Generation Physics. GDC 2014.
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{"figures/Online Gantt 20260211".png}
  \vspace{2mm}
  \includegraphics[width=\textwidth]{"figures/Online Gantt 20260513".png}
  \caption{\textbf{Project Planning and Timeline Comparison.} Top: Initial planning Gantt chart. Bottom: Actual execution Gantt chart. The comparison between the initial plan and final execution highlights our dynamic task reallocation and agile development process throughout the engine's lifecycle.}
...
Our group was uniquely formed by the teaching staff through the strategic merger of three distinct project pitches: a high-speed bicycle action game, an endless-runner title, and a realistic rocket launch simulator. This synthesis of ideas presented both a creative challenge and a unique technical opportunity. We were assigned Rafael Kuffner dos Anjos as our supervisor, whose expertise in high-performance rendering and real-time systems aligned perfectly with our technical ambitions. To ensure a cohesive and achievable project scope, we diplomatically consolidated our vision: we prioritized the high-performance bicycle dynamics as the core gameplay loop, integrated the rocket launch concept as an immersive environmental backdrop, and respectfully pivoted away from the endless-runner mechanics to maintain architectural focus. Throughout the development cycle, we held regular bi-weekly meetings with Rafael, which proved essential for unblocking technical hurdles related to Vulkan synchronization and complex rigid-body constraints.
...
We adopted an agile development strategy, utilizing Git and GitHub for rigorous version control and Discord for near-instantaneous communication. To maintain momentum, Samuil and Sicheng shared managerial responsibilities; Samuil established the initial Gantt charts and high-level task distributions, while Sicheng managed the day-to-day agile tracking by creating and updating granular tasks on our Trello board.

Work distribution was handled fairly and transparently based on individual strengths and interests. The labor was divided across major systems: the Vulkan Renderer Port and Shadow System, Jolt Physics Integration and vehicle control, Flecs ECS integration, and overarching Scene Management. Implementing general controller support was initially a significant hurdle, particularly when handling device-specific polling on Linux; however, the team resolved this by completely refactoring the Input System to integrate natively with the Flecs ECS, which ultimately made the controller implementation seamless and decoupled from the main loop. When specific technical bottlenecks occurred, team members who had finished their tasks early stepped in to pair-program solutions. We utilized a strict Git branching strategy (\texttt{feature/} branches merging into main), preventing individual experiments from breaking the master build. Features deemed too complex for the timeframe, such as a full Animation State Machine, were collectively agreed upon to be postponed to ensure the stability of the core simulation.
...
Our project's trajectory, visualised through the Gantt charts in Figure~\ref{fig:gantt_comparison}, underscores the evolution from a rigid initial roadmap to a responsive, agile workflow. This comparison highlights our dynamic task reallocation and agile development process, particularly as we pivoted resources from the original concept to the high-performance bicycle demo.
...
This project was a crucible for developing professional soft skills that go far beyond the taught material. First and foremost, we learned the critical importance of \textbf{Technical Negotiation}. When integrating different systems, we frequently had to negotiate internal C++ subsystem interfaces and component boundaries. Learning how to compromise and design components to satisfy both rendering and physics requirements without causing friction was a massive learning experience.
...
\textbf{Sicheng Chen}: Leading the development of the Visual UI Editor allowed me to bridge the gap between low-level Vulkan rendering and high-level tool design. Managing our Agile workflow via Trello taught me how to balance technical debt with feature velocity in a high-pressure environment.

\textbf{Samuil Georgiev}: Integrating Jolt Physics and architecting the initial renderer skeleton was a deep dive into deterministic simulation and modern graphics pipelines. I learned that project management is as much about clear initial distribution as it is about technical execution.

\textbf{Qidan Guo}: Implementing the Particle System and optimizing it via GPU instancing provided a practical understanding of hardware-accelerated visual effects. I gained significant experience in managing memory layouts to ensure high performance across different hardware profiles.

\textbf{Junxian Li}: Developing the Audio System using miniaudio and implementing the engine's Event System taught me the importance of decoupled communication in a complex codebase. I now better understand how to design robust interfaces that can handle asynchronous game events without introducing circular dependencies.

\textbf{Chenghao Zhu}: Focusing on the Skeletal Animation System and the Inverse Kinematics solver was a challenging exercise in 3D mathematics and component-based logic. This role improved my ability to implement complex mathematical models within a data-oriented ECS framework.

\section{Summary of Contributions}
\begin{itemize}
    \item \textbf{Sicheng Chen}: Project Management (Agile Trello tracking), Visual UI Editor development, UI Compiler, Runtime UI Debugging panels, and Asset Serialization.
    \item \textbf{Samuil Georgiev}: Project Management (Gantt charts \& initial distribution), Jolt Physics integration, Input System \& Controller support, Initial Renderer skeleton, Original Shadow implementation, Showcase Poster, and Report Writing.
    \item \textbf{Qidan Guo}: Particle System implementation, GPU Instancing optimization, Compute Shader infrastructure, and Technical Documentation.
    \item \textbf{Junxian Li}: Audio System integration (Miniaudio), Event System architecture, Observer pattern implementation, and Input Mapping.
    \item \textbf{Chenghao Zhu}: Skeletal Animation System, 2-Bone IK Solver, GLTF Asset Pipeline, and Scene Management core.
\end{itemize}
