...
namespace engine {
    ...
    Application::Application() {
        ...
        glm::mat4 spawnPos = glm::translate(glm::mat4(1.0f), glm::vec3(25.0f, 120.0f, 35.0f));
        ...
        renderSystem->load_additional_model("Assets/Models/Police Car.glb", false, 40.0f, policeCarSpawnPos);
