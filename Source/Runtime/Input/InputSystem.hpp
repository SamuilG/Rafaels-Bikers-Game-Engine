...
namespace engine {
    ...
    public:
        ...
        void InjectActionValue(const std::string& actionName, float value);
        void InjectGamepadRightStick(glm::vec2 value);
    ...
    private:
        ...
        std::unordered_map<std::string, float> mInjectedActionValues;
        std::optional<glm::vec2> mInjectedRightStick;

        void UpdateKeyboardStates();
        void UpdateGamepadStates();
        void UpdateMouseStates();
        void ApplyInjectedStates();
