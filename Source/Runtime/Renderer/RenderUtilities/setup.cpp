...
{
	return create_depth_buffer(aWindow, aAllocator, engine::StereoRenderTargetDesc{
		aWindow.swapchainExtent.width,
...
lut::ImageWithView create_depth_buffer(
	lut::VulkanWindow const& aWindow,
	lut::Allocator const& aAllocator,
	engine::StereoRenderTargetDesc const& aDesc)
{
	VkImageCreateInfo imageInfo{};
	imageInfo.sType = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
	imageInfo.imageType = VK_IMAGE_TYPE_2D;
	imageInfo.format = aDesc.depthFormat;
	imageInfo.extent.width = aDesc.width;
	imageInfo.extent.height = aDesc.height;
	...
	viewInfo.format = aDesc.depthFormat;
...
{
	return create_offscreen_buffer(aWindow, aAllocator, engine::StereoRenderTargetDesc{
		aWindow.swapchainExtent.width,
		aWindow.swapchainExtent.height,
		VK_FORMAT_R16G16B16A16_SFLOAT,
		cfg::kDepthFormat
...
lut::ImageWithView create_offscreen_buffer(
	lut::VulkanWindow const& aWindow,
	lut::Allocator const& aAllocator,
	engine::StereoRenderTargetDesc const& aDesc)
{
	...
	imageInfo.sType = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
	imageInfo.imageType = VK_IMAGE_TYPE_2D;
	imageInfo.format = aDesc.colorFormat;
	imageInfo.extent.width = aDesc.width;
	imageInfo.extent.height = aDesc.height;
	imageInfo.extent.depth = 1;
	imageInfo.mipLevels = 1;
	...
	viewInfo.image = image;
	viewInfo.viewType = VK_IMAGE_VIEW_TYPE_2D;
	viewInfo.format = aDesc.colorFormat;
