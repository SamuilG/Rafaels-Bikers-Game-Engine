...
namespace engine {
    ...
    // ÔÚ SceneManager µÄÍ·ÎÄ¼þÖÐ¶¨ÒåÇåÎúµÄÎïÀíÀàÐÍÃ¶¾Ù
    enum class ModelPhysicsType {
        Static,   // ¾²Ì¬³¡¾°£¨ÈçÇÅÁº¡¢µØÃæ£©
        Dynamic,  // ÆÕÍ¨¶¯Ì¬¸ÕÌå£¨Èç¹öÄ¾£©
        Compound, // ¸´ºÏÅö×²Ìå
        CustomC   // ÌØÊâ¶¨ÖÆÀàÐÍ£¨Èçµ¥³µ£©
    };

    // ÔÚ SceneManager ÀàÄÚ²¿ÐÂÔö¼ÓÔØº¯Êý
    // ´ËÊ±ËüÐèÒª´«ÈëÒ»¸ö RenderSystem Ö¸ÕëÀ´ºô½Ð GPU ·þÎñ
    // ÔÚ SceneManager.hpp ÄÚ²¿
}
